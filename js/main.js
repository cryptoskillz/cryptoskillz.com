...
outputcode = outputcode+'<script type="text/javascript">SR.init(["'+serverurl+'",15,"https://s3.eu-west-1.amazonaws.com/cryptoskillz.com/srcrypto/prod/cdn/","[ECSUSERID]","3",1,"GB",0,"",0]);';
